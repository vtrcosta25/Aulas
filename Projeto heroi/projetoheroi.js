...
0 sim - O Estágiario falhou miserávelmente em arrumar sua rotina.
1 ou 2 sim - O Estágiario ta com a rotina bagunçada mas ainda consegue arrumar
3 sim - Você estava indo bem mas ainda não conseguiu seu objetivo.
4 sim - Você conseguiu seu objetivo mas ainda falta alguns detalhes para deixar 100%.
5 sim - Parabéns, você conseguiu melhorar todos  os aspectos deixando sua rotina diária melhor.
...
if(pergunta2 == resposta1){
    console.log("Muito bom, se planejou para chegar a tempo independente dos imprevistos");
} else {
        console.log("Talvez se atrase para o trabalho, podendo comprometer seu estágio.");
    }
...
if(pergunta4 == resposta1){
    console.log("Ótimo, boa alimentação é essencial para aguentar a rotina.");
        ...
        console.log("Viver só de lanches vai acabar ficando doente.");
    }
